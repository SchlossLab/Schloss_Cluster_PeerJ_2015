build_ref_mcc_plot <- function(dataset, output_file_name, threshold=0.6){
	...
	pdf(file=output_file_name, width=7.5, height=3.5)
...
build_ref_mcc_plot("he", "results/figures/figure_1.pdf")
build_ref_mcc_plot("schloss", "results/figures/figure_S1.pdf")
